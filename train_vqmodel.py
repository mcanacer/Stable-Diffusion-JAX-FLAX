...
def main(config_path):
    ...
    vqgan = VQModel(**vqmodel_config['params'])
    ...
    vqgan_optimizer = optax.chain(
        optax.adam(
            learning_rate=vqmodel_config['learning_rate'],
            b1=vqmodel_config['b1'],
            b2=vqmodel_config['b2'],
        ))
    ...
    lpips_params = lpips.init(key, jnp.ones((2, 256, 256, 3)), jnp.ones((2, 256, 256, 3)))
